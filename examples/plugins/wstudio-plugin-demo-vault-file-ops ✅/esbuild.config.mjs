/**
 * Bundles the vault file operations demo plugin into a host-loadable CommonJS file.
 */
...
async function main() {
  ...
  console.log('[wstudio-plugin-demo-vault-file-ops] watching TypeScript sources');
