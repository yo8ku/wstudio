/**
 * Bundles the release channel demo plugin into a host-loadable CommonJS file.
 */
...
async function main() {
  ...
  console.log('[wstudio-plugin-demo-manifest-release-channel] watching TypeScript sources');
