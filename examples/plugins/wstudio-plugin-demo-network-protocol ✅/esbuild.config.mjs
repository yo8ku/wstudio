/**
 * Bundles the network and protocol demo plugin into a host-loadable CommonJS file.
 */
...
async function main() {
  ...
  console.log('[wstudio-plugin-demo-network-protocol] watching TypeScript sources');
