/**
 * Bundles the global event and timer demo plugin into a host-loadable CommonJS file.
 */
...
async function main() {
  ...
  console.log('[wstudio-plugin-demo-global-event-timer] watching TypeScript sources');
