/**
 * Bundles the settings persistence demo plugin into a host-loadable CommonJS file.
 */
...
async function main() {
  ...
  console.log('[wstudio-plugin-demo-settings-persistence] watching TypeScript sources');
