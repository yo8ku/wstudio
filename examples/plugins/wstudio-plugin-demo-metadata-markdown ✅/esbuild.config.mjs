/**
 * Bundles the metadata markdown demo plugin into a host-loadable CommonJS file.
 */
...
async function main() {
  ...
  console.log('[wstudio-plugin-demo-metadata-markdown] watching TypeScript sources');
