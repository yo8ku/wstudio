...
export type AIPanelSkillContributionEntry = AIPanelSkillCommandContributionEntry | AIPanelSkillToolContributionEntry;
export type AIPanelContributionEntry = AIPanelCommandContributionEntry | AIPanelSkillContributionEntry;
...
export declare const EMPTY_AI_PANEL_CONTRIBUTION_SNAPSHOT: AIPanelContributionSnapshot;
...
export type AIPanelContributionExecutionOutcome = AIPanelContributionHandledOutcome | AIPanelContributionInsertTextOutcome;
export interface AIPanelContributionExecutionResponse {
    readonly success: boolean;
    readonly data?: AIPanelContributionExecutionOutcome;
    readonly error?: AIPanelContributionError;
}
//# sourceMappingURL=ai-panel-contribution.d.ts.map