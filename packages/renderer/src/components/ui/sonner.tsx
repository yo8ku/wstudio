  ...
  return (
    <Sonner
      ...
      toastOptions={{
        classNames: {
          toast:
            "group toast group-[.toaster]:bg-[var(--ws-notifications-background)] group-[.toaster]:text-[var(--ws-notifications-foreground)] group-[.toaster]:border-[var(--ws-notifications-border)] group-[.toaster]:shadow-lg group-[.toaster]:flex group-[.toaster]:items-center group-[.toaster]:gap-2",
