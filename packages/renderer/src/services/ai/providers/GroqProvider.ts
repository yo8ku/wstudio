/**
 * Groq AI提供商实现
 * 功能：提供Groq API的完整功能，包括推理、工具调用等
 * 描述：支持Llama、Mixtral、Gemma等开源模型
 */
...
export class GroqProvider extends BaseAIProvider {
  ...
  async searchWeb(query: string, config?: WebSearchConfig): Promise<WebSearchResult[]> {
    throw new Error('Web search not directly supported by Groq. Use function calling with web search tools.');
  }
