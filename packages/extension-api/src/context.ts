...
export type CommandHandler =
  (...args: readonly JsonValue[]) => JsonValue | void | Promise<JsonValue | void>;
...
export type ExtensionWebviewMessageHandler =
  (message: JsonValue) => void | Promise<void>;
...
export interface ExtensionWebviewPanel {
  ...
  onMessage(handler: ExtensionWebviewMessageHandler): Disposable;
  reveal(): Promise<void>;
...
export type ExtensionAIToolHandler =
  (input: JsonObject) => JsonValue | void | Promise<JsonValue | void>;
