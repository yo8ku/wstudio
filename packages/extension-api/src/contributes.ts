...
export const SETTING_VALUE_TYPES = ['string', 'number', 'boolean', 'select'] as const;
...
export type AIPanelSkillContribution =
  | AIPanelSkillCommandContribution
  | AIPanelSkillToolContribution;
...
export const EMPTY_AI_PANEL_CONTRIBUTES: AIPanelContributes = {};

export const EMPTY_EXTENSION_CONTRIBUTES: ExtensionContributes = {
  aiPanel: EMPTY_AI_PANEL_CONTRIBUTES,
};
