...
export const EMBEDDING_PROVIDERS: EmbeddingProviderConfig[] = [
  ...
  },
  {
    id: 'siliconflow',
    name: '硅基流动',
    defaultEndpoint: 'https://api.siliconflow.cn/v1/embeddings',
    apiKeyUrl: 'https://cloud.siliconflow.cn/account/ak',
    models: [
      {
        id: 'BAAI/bge-m3',
        name: 'BAAI/bge-m3',
        displayName: 'BGE-M3 (硅基流动)',
  ...
  },
  {
    id: 'volcengine',
    name: '火山引擎',
    defaultEndpoint: 'https://ark.cn-beijing.volces.com/api/v3/embeddings',
    ...
    models: [
      {
        ...
        apiEndpoint: 'https://ark.cn-beijing.volces.com/api/v3/embeddings',
        dimensions: 2560,
        maxTokens: 4096,
        supportsBatch: true,
        maxBatchSize: 16,
