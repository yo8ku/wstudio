...
export type PluginActivationEvent = 'onStartup' | 'onWorkspaceReady' | `onCommand:${string}` | `onView:${string}` | `onLanguage:${string}` | `workspaceContains:${string}`;
export type PluginUILayoutLocation = 'activitybar-left' | 'titlebar' | 'statusbar' | 'editor-tab-right' | 'sidebar-toolbar' | 'bottom-panel-toolbar';
...
export type PluginUILayoutContribution = PluginCommandLayoutContribution | PluginViewLayoutContribution;
...
export type PluginLoadHandler = (context: PluginContext, app: PluginApp) => void | Promise<void>;
export type PluginUnloadHandler = (context: PluginContext) => void | Promise<void>;
