...
export type PluginCommandHandler = (...args: PluginJsonValue[]) => PluginCommandResult | Promise<PluginCommandResult>;
...
export interface PluginAIApi {
    ...
    streamChat(modelId: string, messages: readonly PluginAIChatMessage[], callbacks: PluginAIStreamCallbacks): Promise<void>;
}
